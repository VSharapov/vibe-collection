...
generate_key_with_entropy "key1_normal" "/dev/urandom" "Normal key generation #1"
generate_key_with_entropy "key2_normal" "/dev/urandom" "Normal key generation #2"
...
generate_key_with_entropy "key1_high" "$WORKDIR/high_entropy" "High entropy key generation #1"
generate_key_with_entropy "key2_high" "$WORKDIR/high_entropy" "High entropy key generation #2"
...
generate_key_with_entropy "key1_low" "$WORKDIR/low_entropy" "Low entropy key generation #1"
generate_key_with_entropy "key2_low" "$WORKDIR/low_entropy" "Low entropy key generation #2"
...
generate_key_with_entropy "key1_medium" "$WORKDIR/medium_entropy" "Medium entropy key generation #1"
generate_key_with_entropy "key2_medium" "$WORKDIR/medium_entropy" "Medium entropy key generation #2"

echo "Step 9: Compare medium entropy keys"
compare_keys "key1_medium" "key2_medium" "Medium entropy keys comparison"

echo "Step 10: Show key fingerprints for analysis"
...
echo "Check $WORKDIR for all generated keys"